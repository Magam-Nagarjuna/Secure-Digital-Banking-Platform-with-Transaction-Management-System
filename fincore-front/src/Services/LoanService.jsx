...
export const getLoansByStatus = (status) =>
  axios.get(`${BASE_URL}/loan-status/${status}`, config);

export const applyForLoan = (application) =>
  axios.post(APPLICATION_URL, application, config);
...
export const repayLoan = (applicationId, repayment) =>
  axios.post(
    `${APPLICATION_URL}/${applicationId}/repayments`,
    repayment,
    config,
  );
