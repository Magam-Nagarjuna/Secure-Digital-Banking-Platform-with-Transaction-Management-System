...
public class LoanApplicationService {
        ...
        public LoanApplication apply(LoanApplication application) {
                ...
                Account savings = accountDao.getAccountByAccountNumber(
                ...
                double amount = application.getLoanAmount() == null
                ...
                int years = application.getLoanTenure() == null
                ...
                double rate = scheme.getInterestRate() == null
                                ? 0
        ...
        public LoanApplication approve(String applicationId) {
                ...
                if (savings == null
                                || !application.getCustomerId().equals(savings.getCustomerId())
                                || !ACTIVE.equalsIgnoreCase(savings.getStatus())
                ...
                double balance = savings.getBalance() == null
                                ? 0.0
                                : savings.getBalance();
                ...
                Account payment = accountService.createLoanAccount(
        ...
        public LoanRepayment repay(
                ...
                double outstanding = application.getOutstandingAmount() == null
                                ? 0.0
                                : round2(application.getOutstandingAmount());
                ...
                double emi = application.getEmiPayable() == null
                                ? 0.0
                                : round2(application.getEmiPayable());
                ...
                int paidTenures = application.getPaidTenure() == null
                                ? 0
                                : application.getPaidTenure();

                int totalTenures = application.getTotalTenure() == null
                                ? 0
                                : application.getTotalTenure();

                if (paidTenures + 1 >= totalTenures || outstanding <= emi + 10) {
                        amount = outstanding;
                } else {
                        amount = emi;
                }

                Long loanAccountNumber = application.getPaymentAccountNumber();

                if (loanAccountNumber == null) {

                        loanAccountNumber = application.getAccountNumber();
                }
                ...
                Account loanAccount = accountDao.getAccountByAccountNumber(
                                loanAccountNumber);
                ...
                Long savingsAccountNumber = application.getSavingsAccountNumber();
                ...
                double savingsBalance = savings.getBalance() == null
                                ? 0.0
                                : round2(savings.getBalance());
                ...
                int nextPaidTenure = (application.getPaidTenure() == null
                                ? 0
                ...
                double loanBalance = loanAccount.getBalance() == null
                                ? 0.0
